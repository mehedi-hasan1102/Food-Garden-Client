...
const Loader = () => {
  return (
    <StyledLoader>
      <div className="loader m-12">
        <div className="truck">
          <div className="body">
            {/* Truck SVG */}
            <svg className="truck-svg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93">
          ...
          <div className="tires">
            {/* Tire SVG x2 */}
            {[1, 2].map((_, i) => (
              <svg key={i} className="tire-svg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30">
          ...
          {/* Lamp Post */}
          <svg className="lamp-post" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 453.459 453.459" fill="#000000">
...
const StyledLoader = styled.div`
  ...
  .road::after {
    ...
    height: 100%;
    background: #282828;
    animation: moveRoad 1.4s linear infinite;
