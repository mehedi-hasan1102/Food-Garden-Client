...
const ExtraSections = () => {
  return (
    <section className="max-w-8xl mx-auto px-4 py-14 bg-gradient-to-b from-[#fffaf5] to-white dark:from-[#1f1f1f] dark:to-[#1f1f1f] transition-colors duration-300 rounded-2xl ">
